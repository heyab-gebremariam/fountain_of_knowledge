                    ...
                    <div className="col-lg-6 about-img wow fadeInUp" data-wow-delay="0.5s">
                        <div className="row">
                            <div className="col-12 text-center">
                                <img className="img-fluid w-75 rounded-circle bg-light p-3" src="/theme/img/about-1.jpg" alt="" />
                            </div>
                            <div className="col-6 text-start">
                                <img className="img-fluid w-100 rounded-circle bg-light p-3" src="/theme/img/about-2.jpg" alt="" />
                            </div>
                            <div className="col-6 text-end">
                                <img className="img-fluid w-100 rounded-circle bg-light p-3" src="/theme/img/about-3.jpg" alt="" />
                            </div>
                        </div>
                    </div>
                </div>
